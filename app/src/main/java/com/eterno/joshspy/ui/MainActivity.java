...
//                return true;
    ...
    private android.app.AlertDialog buildAppServiceAlertDialog(){
        android.app.AlertDialog.Builder alertDialogBuilder = new android.app.AlertDialog.Builder(this);
        alertDialogBuilder.setTitle( R.string.enable_josh_spy);
        alertDialogBuilder.setMessage(R.string.enable_joshspy_explanation);
