...
public class SendFGServiceDataToSheet extends AsyncTask<String, Void, String> {

  private static final String userId = AppUtil.getClientId();
  private static final String TAG = "SendFGServiceToSheet";
  ...
  protected String doInBackground(String... arg0) {
    try {
      ...
      postDataParams.put("req_type", "SERVICE");
